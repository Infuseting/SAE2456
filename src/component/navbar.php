        ...
        <div class="dropdown dropdown-end">
            <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
                <div class="indicator">
                    ...
                    <span class="badge badge-sm indicator-item"><?php echo '0' ?></span>
                </div>
            </div>
            <div
                tabindex="0"
                ...
                <div class="card-body">
                    <span class="text-lg font-bold"><?php echo '0' ?> Items</span>
                    <span class="text-info">Subtotal: $<?php echo '0' ?></span>
